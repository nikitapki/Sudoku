...
class DifficultyMediumButton : public IButton {
public:
    ...
    int getYStart() override {
        return MIN_Y_FROM_CONSOLE_COLUMN_MENU_BUTTON_DIFFICULT_MEDIUM;
    }
    int getYEnd() override {
        return MAX_Y_FROM_CONSOLE_COLUMN_MENU_BUTTON_DIFFICULT_MEDIUM;
    }
